                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                    <span
                                        class="text-success">{{ number_format($statusPercentages['in_progress'], 2) }}%</span>
                                </div>
                            </div>
                                        ...
                                        <div class="dropdown action-label">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                @foreach(['pending' => 'text-info', 'on_hold' => 'text-danger', 'closed' => 'text-success', 'in_progress' => 'text-success'] as $status => $color)
                                                    <form
                                                        action="{{ route('service-request.updateStatus', ['id' => $service_request->id]) }}"
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                    href="{{route('request.edit', $service_request->id)}}"><i
