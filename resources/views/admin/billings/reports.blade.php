...
<div class="content container-fluid">
    ...
    @include('layouts.partials.filter', [
        'filterRoute' => route('billing.report'),
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{ route('billing.receipt', $billing->id) }}" target="_blank">
                                            <i class="fa fa-print m-r-5"></i> Receipt
                                        </a>
                                        <a class="dropdown-item" href="{{ route('billing.pdf', $billing->id) }}" target="_blank">
                                            <i class="fa fa-file-pdf-o m-r-5"></i> PDF Invoice
                                        </a>
